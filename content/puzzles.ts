...
export const PUZZLES: ChessPuzzle[] = [
  ...
  // Daily puzzle batch — 2026-09-20. Hand-composed, verified via
  // `node scripts/verify-puzzles.js <candidates.json>` before being added here.
  { id: "m1-damiano-mate",     fen: "7k/6pp/6P1/8/8/7Q/8/K7 w - - 0 1",     sideToMove: "w", mateIn: 1, theme: "Damiano's Mate",     level: 1 },
  { id: "m1-blackburne-mate",  fen: "6k1/5p1p/8/8/6N1/B7/1B6/K7 w - - 0 1", sideToMove: "w", mateIn: 1, theme: "Blackburne's Mate",  level: 1 },
