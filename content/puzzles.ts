...
export const PUZZLES: ChessPuzzle[] = [
  ...
  // Daily puzzle batch — 2026-09-25. Hand-composed, verified via
  // `node scripts/verify-puzzles.js <candidates.json>` before being added here.
  { id: "m1-arabian-corner",       fen: "7k/6p1/5N2/8/8/8/8/KR6 w - - 0 1",    sideToMove: "w", mateIn: 1, theme: "Arabian Mate",       level: 1 },
  { id: "m2-smothered-queen-sac",  fen: "5r1k/6pp/4Q2N/8/8/8/8/K7 w - - 0 1",  sideToMove: "w", mateIn: 2, theme: "Smothered Mate",     level: 3 },
  { id: "m1-rook-bishop-corner",   fen: "7k/5K2/8/R7/8/3B4/8/8 w - - 0 1",     sideToMove: "w", mateIn: 1, theme: "Rook & Bishop Mate", level: 1 },
];
