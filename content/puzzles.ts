...
export const PUZZLES: ChessPuzzle[] = [
  ...
  // Daily puzzle batch — 2026-09-15. Hand-composed, verified via
  // `node scripts/verify-puzzles.js <candidates.json>` before being added here.
  { id: "m1-damiano-queen-pawn",    fen: "7k/7p/5PQ1/8/8/8/8/4K3 w - - 0 1",     sideToMove: "w", mateIn: 1, theme: "Damiano's Mate",   level: 1 },
  { id: "m1-anastasia-knight-rook", fen: "7k/6p1/5N2/8/8/8/8/K2R4 w - - 0 1",    sideToMove: "w", mateIn: 1, theme: "Anastasia's Mate", level: 1 },
  { id: "m2-smothered-queen-sac",   fen: "5r1k/6pp/7N/8/8/1Q6/8/K7 w - - 0 1",   sideToMove: "w", mateIn: 2, theme: "Smothered Mate",   level: 3 },
];
